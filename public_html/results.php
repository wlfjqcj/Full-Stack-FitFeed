...
//        echo "<script>console.log( " . $buyer . " );</script>";
        ...
        $updateuser = $conn->query("UPDATE user_info SET user_info.sweet={$user_sweetness}, user_info.sour='$user_sourness', user_info.hot={$user_spicyness}, user_info.salty={$user_saltyness} WHERE username = '$buyer'" );
